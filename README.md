...
4.
-when input of elements is completed go iteratively through the graph matrix and replace -1 with infintiy because there is no edge between those vertices 
